...
libpath = ctypes.util.find_library('SC2_Cam')
print(libpath)
...
class DAQ_2DViewer_PCOEdge_4p2(DAQ_Viewer_base):
    ...
    def __init__(self, parent=None, params_state=None):
        ...
        super(DAQ_NDViewer_Template, self).__init__(parent,
    ...
    def emit_data(self):
        ...
        try:
            ...
            self.data_grabed_signal.emit([OrderedDict(name='Camera', data=[
                np.squeeze(self.data.reshape((sizey, sizex)).astype(np.float))], type=self.data_shape)])
            #######################################################################
            ##################################################################
    ...
    def close(self):
        ...
        if temp < -20:
            ...
            msgBox.setInformativeText(
                "The cooling will be maintained while shutting down camera. Keep it power plugged!!!");
            msgBox.show()
